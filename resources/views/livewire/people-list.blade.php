<div class="pb-6">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-blue-500/20 p-6 mb-6">
            ...
            <div class="space-y-3">
                @foreach($people as $person)
                    <div class="bg-gradient-to-br from-gray-50 to-blue-50/30 rounded-2xl p-4 hover:shadow-md transition-all">
                        ...
                        <div class="flex items-center gap-2 pt-3 border-t border-gray-200/50">
                            <a href="/people/{{ $person->id }}" wire:navigate class="flex-1 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-xl text-sm font-medium text-center transition-colors shadow-md shadow-blue-500/30">
                                View Details
                            </a>
                            <button wire:click="edit({{ $person->id }})" class="px-4 py-2 bg-white hover:bg-gray-50 text-gray-700 rounded-xl text-sm font-medium transition-colors border border-gray-200">
                            ...
                            <button
                                ...
                                class="px-4 py-2 bg-white hover:bg-red-50 text-red-600 rounded-xl text-sm font-medium transition-colors border border-gray-200"
                            >
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    @else
        <div class="bg-white rounded-3xl shadow-xl shadow-blue-500/20 p-12 text-center">
            ...
            @if(!$search)
                ...
                <button wire:click="openForm" class="inline-flex items-center px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-2xl font-semibold shadow-lg shadow-blue-500/50 transition-all">
    ...
    @if($showForm)
        <div class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-end sm:items-center justify-center z-50 p-0 sm:p-4" wire:click.self="cancel">
            <div class="bg-white rounded-t-3xl sm:rounded-3xl w-full sm:max-w-lg sm:mx-4 max-h-[90vh] overflow-y-auto shadow-2xl">
                ...
                <form wire:submit.prevent="save">
                    ...
                    <div class="sticky bottom-0 bg-white px-6 py-5 border-t border-gray-100 flex gap-3 rounded-b-3xl">
                        ...
                        <button
                            type="submit"
                            class="flex-1 px-6 py-4 bg-blue-500 hover:bg-blue-600 text-white rounded-2xl text-base font-semibold shadow-lg shadow-blue-500/50 transition-all"
                        >
