    ...
    <div class="min-h-screen pb-20 sm:pb-6">
        ...
        <div class="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-lg border-t border-gray-200/50 shadow-lg sm:hidden z-50 pb-safe rounded-t-3xl">
            <div class="grid grid-cols-2 px-6 py-2">
                <a href="/" wire:navigate class="flex flex-col items-center justify-center py-3 text-gray-600 hover:text-blue-600 transition-colors">
                ...
                <a href="/people" wire:navigate class="flex flex-col items-center justify-center py-3 text-gray-600 hover:text-blue-600 transition-colors">
        ...
        <div class="hidden sm:block fixed top-6 right-6 z-50">
            <div class="flex items-center space-x-3 bg-white/95 backdrop-blur-lg rounded-2xl px-4 py-2 shadow-lg">
                <a href="/" wire:navigate class="px-4 py-2 rounded-xl text-sm font-medium transition-all {{ request()->is('/') ? 'bg-blue-500 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                    Home
                </a>
                <a href="/people" wire:navigate class="px-4 py-2 rounded-xl text-sm font-medium transition-all {{ request()->is('people*') ? 'bg-blue-500 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                    History
                </a>
            </div>
        </div>
